...
**定位**：[`README.md`](README.md) 只做入口与一条命令；**完整说明只在本文件**（避免与 README 重复）。  
**仓库**：<https://github.com/znygithub/bilibili-transcript>  
「字幕 / ASR 先后的决策树」见 [`TRANSCRIPT_STRATEGY.md`](TRANSCRIPT_STRATEGY.md)。
